...
// アプリ名＋バージョン
AppVerName=zLog 令和 Edition Version 2.9.6.1
...
Source: "files\zlog_v2961_release_note.pdf"; DestDir: {app}; Components: "Options\Documents";
